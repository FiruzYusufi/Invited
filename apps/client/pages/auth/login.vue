  ...
  <div class="min-h-screen bg-hero-gradient flex items-center justify-center px-6">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        <h1 class="font-display text-4xl text-stone-800 mb-2">Добро пожаловать</h1>
        <p class="text-stone-600 font-serif">Войдите в свой аккаунт</p>
      </div>
      ...
      <form @submit.prevent="login" class="glass-card p-8 space-y-6">
        ...
        <div class="text-center">
          <p class="text-stone-600 font-serif">
            Нет аккаунта? 
            <NuxtLink to="/auth/register" class="text-champagne-600 hover:text-champagne-700 transition-colors">
              Зарегистрироваться
            </NuxtLink>
          </p>
        </div>
