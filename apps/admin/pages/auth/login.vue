  ...
  <div class="min-h-screen bg-hero-gradient flex items-center justify-center px-6">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        <h1 class="font-display text-4xl text-stone-800 mb-2">Invited Admin</h1>
        <p class="text-stone-600 font-serif">Вход для администраторов</p>
      </div>
